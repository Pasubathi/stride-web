...
class ProductLaptop extends React.Component {
    ...
    componentDidMount() {
        this.props.getProductByCategoryData('Laptop').then((response) => {
                ...
                <section className="pt-lg-5 pb-lg-3 overflow-hidden laptop-catgory-block">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="d-flex justify-content-between align-items-center mb-2 shopby-after-bg-image position-rel"><h3 className="section_title mb-lg-4 mb-3">Top Deals on Laptops</h3><a href="#" className="text-decoration-none fs-14 font-weight-bold d-block">View All <i className="ml-2 fa fa-angle-right fs-14 font-weight-bold" aria-hidden="true"></i></a></div>
