...
class ProductMobile extends React.Component {
    ...
    componentDidMount() {
        this.props.getProductByCategoryData("Mobile").then((response) => {
                ...
                <section className="bg0 pt-lg-3 pb-lg-3 overflow-hidden mobile-category-block">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="d-flex justify-content-between align-items-center mb-2 shopby-after-bg-image position-rel"><h3 className="section_title mb-lg-4 mb-3">Upgrade Your Phones with STRIDE Deals</h3><a href="#" className="text-decoration-none fs-14 font-weight-bold d-block">View All <i className="ml-2 fa fa-angle-right fs-14 font-weight-bold" aria-hidden="true"></i></a></div>
