                ...
                <div className="slider-column">
                   <div className="leftcol">
                      ...
                      <picture>
                            ...
                            <source srcSet={`images/slider/slide-01.png`} media="(min-width: 568px)" />
                             <img src={`images/slider/slide-mob.png`} alt="" />
                      </picture>
                   </div>
                    <div className="caption position1">
                      <h3>  <img src={`images/store/apple_logo.png`} /> MacBook Air</h3>
