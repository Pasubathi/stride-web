...
class School extends React.Component {
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getProductByCategory(data)).then((response) => {
            if (response && response.data.length > 0) {
                this.setState({ school_data: response.data });
            }
        });
    }
    ...
    render() {
        return (
            <>
                <section className="bg0 pt-lg-3 pb-lg-3 overflow-hidden kids-school-block">
                    <div className="container">
                        <div className="row">
                            <div className="col mb-2 school">
                          
                            <div className="d-flex justify-content-between align-items-center mb-2 shopby-after-bg-image position-rel">
                            <h3 className="section_title mb-lg-4 mb-3">Schools for Your Kids</h3>
                               ...
                               <i className="ml-2 fa fa-angle-right fs-14 font-weight-bold" aria-hidden="true"></i></a>
                                ...
                                <Carousel responsive={responsive}>
                                     ...
                                     {this.state.school_data && this.state.school_data !== undefined && this.state.school_data.length > 0?(
                                        this.state.school_data.map((item, index) => (
