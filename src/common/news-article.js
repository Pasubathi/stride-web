                        ...
                        <Carousel responsive={responsive}>
                           {/*  <div className="item d-flex flex-column blog-card">
                            ...
                            { blog_list.map((item, index)=> (
                             <div key={`related-blog-${index}`} className="item d-flex flex-column blog-card">
                                <div className="img-box">
                                ...
                                <div className="bottom">
                                    ...
                                    <div className="blog-footer">
                                    <span>~{item.name?item.name.slice(0, 10):''}</span>
                                    <span className="readmore"><a href={item.website_url__c}>Read More   <img src={`images/arrow-right.png`} className="img-fluid"/> </a></span>
                                    </div> 
                                </div>
                                </div>
                             </div>
