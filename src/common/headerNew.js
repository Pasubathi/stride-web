...
import {getGlobalSearch, trendingSearchRemove} from "../actions/product";
...
class HeaderNew extends Component {
    ...
    searchProduct = (search) => {
        this.props.dispatch(getGlobalSearch(search)).then((response) => {
            if (response && response.status === "success") {
    ...
    render() {
        const {user, username, isSearching, searchDet, favorite_count, sfid} = this.props
        const {
            selectedTab,
            searchData,
            search,
                                                ...
                                                <ul className="sub-main-menu">
                                                    {
                                                        category && category.map(item => (
                                                            <li key={item.category_id} className="active-menu">
                                                                <a href={"/products-list?category=" + encodeURI(item.category_name)}>
                                                                    <span><img className="storeicon"
                                            ...
                                            <div className='top_search_box_wrapper shadow_'>
                                                ...
                                                <div className='top_search_box'>
                                                    <input
                                                        ...
                                                        type="text"
                                                        placeholder='Search for your dream products'
                                                        name="search"
                                                ...
                                                <button className='search-submit' type=''  onClick={this.handleClear}>
                                                    <img src={`${asset}images/icons/search_icon.png`} alt="" className='img-fluid'/>
                                                        ...
                                                        {!this.state.search && (
                                                            <div className='p-3 whiteSmokeBg'>
                                                                {searchMenu && (
                                                    ...
                                                    <div className='col-sm-8'>
                                                        <div className="d-flex justify-content-between align-items-center mb-2 position-rel"><h3 className="section_title mb-lg-4 mb-3">Top Products</h3></div>
                                                        <div className="previous_search_result_wrapper">
                                                            <ul className="d-flex electric psrw list-unstyled m-0 position-relative">
                                                                ...
                                                                {/* <li>
                                                                    <div className="item d-flex flex-column">
                                                                        ...
                                                                        <div className="img-box px-3">
                                                                            <img src={`${asset}images/products/tele01.png`} className="img-fluid"/>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                        ...
                                                        <div className="p-3 whiteSmokeBg">
                                                            {/* <div className='row'>
                                                    <div className='col auto_s_r_ py-3'>
                                                        <ul className=''>
                                                            <li className='d-flex align-items-center mb-3'>
                                                            <img src={`${asset}images/icons/search_icon.png`} alt="" className='img-fluid'/>
                                                            Laptops Under <span>40,000</span> 
                                                            </li>
                                                            <li className='d-flex align-items-center mb-3'>
                                                            <img src={`${asset}images/icons/search_icon.png`} alt="" className='img-fluid'/>
                                                            Laptops Under <span>40,000</span> 
                                                            ...
                                                            <div className='row'>
                                                                <div className='col px-0'>
                                                                    <Scrollbar style={{display: "block", width: "100%", minHeight: "40px", maxHeight:"250px"}} >
                                                                        {searchData && searchData.length > 0 ? (
                                                                            <ul className='search_p_list'>
                                                                                {searchData.map((item, index) => (
                                                                                    <li key={`search-product-${index}`}
                                                                                        id={item.sfid}
                                                                                        className='d-flex align-items-start py-2 px-2 cursor-point search-product'>
                                                                                        <div className='pit_img'>
                                                                                            <img
                                                                            ...
                                                                            <div className='px-3'>
                                                                                <ContentLoader viewBox="0 0 380 70">
                                                                                    <rect x="0" y="0" rx="5" ry="5"
                                                                                          width="70" height="70"/>
                                                                                    <rect x="80" y="17" rx="4" ry="4"
                                                                                          width="300" height="13"/>
                                                                                    <rect x="80" y="40" rx="3" ry="3"
                                                                                          width="250" height="10"/>
                                                                                </ContentLoader>
                                                                            </div>
                                                                        ) : (
                                                                            <ul>
                                                                                <li key={`search-product-0`}
                                                                                    className='d-flex align-items-start py-2 px-2 cursor-point'>
                                                                                    {/* <div className='pd_txt'>
                                                                    <p className='m-0'>Search record not found</p>
                                                                </div> */}
                                                                                </li>
                                                                            </ul>
                                                                        )}
                                        ...
                                        user || sfid ? (
                                            <>
                                                ...
                                                <div className="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <button onClick={this.handleLogout} className="w-100 px-3"
                                                            type="button">Logout
                                                    </button>
                                                </div>
                    ...
                    <div className="sub-header d-none d-lg-block">
                        <div className="site-header-wrap container">
                                ...
                                <ul className="sub-main-menu">
                                    {
                                        category && category.map(item=>(
                                            <li key={item.category_id} className="active-menu">
                                                <a href={"/products-list?category="+encodeURI(item.category_name)}><img
                            ...
                            <div className="sub-right-menu">
                                <ul className="sub-main-menu">
                                    <li className="active-menu">
                                        <a href="#"><img className="storeicon" src={`${asset}images/coins1.png`}/> Get a
