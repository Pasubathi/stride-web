...
import { getActiveVirtualCards, getClosedVirtualCards, checkVirtualCards } from "../../actions/product";
import { getAccountProfile, getStore } from "../../actions/user";
                            ...
                            <div className='row'>
                                ...
                                <div className='card-left'>
                                  <div className='row h-100'>
                                    ...
                                    <div className='p-4'>
                                        <h3 className='font-weight-semibold mb-4'>What is Stride Virtual Card? 33333</h3>
                                        <p>A virtual card is a unique &amp; digitally generated 16-digit credit card number that helps you pay for all online subscriptions. Your card number is private, reducing any fraud risks.</p>
                                  ...
                                  <div className='row align-items-center h-100'>
                                    ...
                                    <div className='col-lg-6'>
                                        ...
                                        <Carousel responsive={responsive} activeIndex={this.state.index} onSelect={this.handleSelect}>
                                            ...
                                            <div key={`active-vcard-${index}`} className='position-relative'>
...
{/* 
                          ...
                          <div className='col-12'>
                              ...
                              <ul className='popular-store-logos'>
                                {storeList && storeList.length > 0 && storeList.map((item, index)=>(
                                  <li key={`store-${index}`}><img src={item.icon} className='img-fluid'/></li>
                                ))}
  ...
  function mapStateToProps(state) {
    ...
    const { virtual_active_cards, virtual_closed_cards, favorite_count } = state.product;
