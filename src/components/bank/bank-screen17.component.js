                        ...
                        <div className='row justify-content-center'>
                            ...
                            <div className='col-sm-9'>
                                <div className='w-100 mb-5 c_p_m_b pb-4'>
                                    ...
                                    <p className='text-center mt-3'>We are unable to verify your account, please upload bank statement to verify manually</p>
                                            ...
                                            <div className="col-sm-12 d-flex justify-content-center">
                                                <div className="col-sm-6">
                                                    {this.state.isSuccess && (
                                                        <button type="button" onClick={() => this.props.history.push("/ed_enach")} className={"flex-c-m cl0 size-121 bor1 p-lr-15 trans-04 pointer mr-btn-sty btn-normal"} style={btnStyle} >
                                                            Continue
                                                        </button>
                                                    )}
                                                </div>
