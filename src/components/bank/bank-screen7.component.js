...
import { updateLimit } from "../../actions/user";
                        ...
                        <div className="col-md-12">
                            ...
                            <div className="row">
                                <div className="col-sm-12 d-flex justify-content-center">
                                    ...
                                    <button type="button" onClick={this.updateLimit} className={"flex-c-m cl0 size-121 bor1 p-lr-15 trans-04 pointer mr-btn-sty btn-normal"} style={btnStyle} >
                                         Continue
                                    </button>
                                        )}
                                    </div>
