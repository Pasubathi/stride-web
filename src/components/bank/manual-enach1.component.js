    ...
    <div className='row mb-4'>
        <div className='col'>
          <div className="d-flex align-items-center">
            <button className="back-btn rounded-circle mr-3"><i className="fa fa-arrow-left" aria-hidden="true"></i></button><h4 className="mb-0">Product Summary</h4></div>
        </div>
    </div>
    <div className='row'>
    <div className='col-xl-3 col-lg-4'>
      <div className=''>
        ...
        <div className="d-flex align-items-center at-dropdown">
          <h5 className="mb-3 d-flex align-items-center mb-0">All Transactions 
          <i className="fa fa-angle-down h4  mb-0 ml-2" aria-hidden="true"></i></h5>
        </div>
        

        <div className="transaction-block-wrap">
          <div className="bg-white p-4 transaction-block mb-2">
            <div className="d-flex justify-content-between">
              <div>
                <h5>Apple India</h5>
                <p>Due on Nov 20, 2021</p>
                <h5><i className="rupee">`</i> 30.000</h5>
              </div>
              <div className="d-flex flex-column justify-content-between">
              <span><img src={asset+"images/icons/apple_logo.png"} alt="user" className="img-fluid" style={{"width":"20px"}}/></span>
          ...
          <div className="bg-white p-4 transaction-block mb-2">
            <div className="d-flex justify-content-between">
              ...
              <div className="d-flex flex-column justify-content-between">
              <span><img src={asset+"images/icons/amazon.png"} alt="user" className="img-fluid" style={{"width":"20px"}}/></span>
                <p className="mb-0">6/12</p>
              </div>
            </div>
            <div className="pro-bar-wrap">
          ...
          <div className="bg-white p-4 transaction-block mb-2">
            <div className="d-flex justify-content-between">
              ...
              <div className="d-flex flex-column justify-content-between">
              <span><img src={asset+"images/icons/flipkart.png"} alt="user" className="img-fluid" style={{"width":"20px"}}/></span>
                <p className="mb-0">6/12</p>
              </div>
            </div>
            <div className="pro-bar-wrap">
        ...
        <div className="bg-white p-4 transaction-block mb-2">
          ...
          <div className="bg-white p-4 transaction-block">
          <div className="row align-items-center">
          <div className="col-4">
              <img src={asset+"images/meter.png"} alt="" className="img-fluid"/>
          </div>
          <div className="col-8 text-right">
            <p>Available Limit</p>
            <h4><i className="rupee">`</i> 30.000</h4>
          </div>
          </div>
          <hr></hr>
          <div className="text-center "><button className="link font-weight-medium">Go to Marketplace</button></div>
          </div>
        </div>
                ...
                <div className="row">
                  <div className="col-lg-4 mb-lg-0 mb-3">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <button><i className="fa fa-arrow-circle-o-down" aria-hidden="true"></i></button>    
                      </div>
                 </div>
                    <div className="col-lg-4 mb-lg-0 mb-3">
            ...
            <div className="row">
              <div className="col">
                <div className="text-center">
                  <button className="ltt_toggle"><i className="fa fa-angle-down h4" aria-hidden="true"></i></button>
                </div>
