...
class KycAddressScreen2 extends Component {
  ...
  handleChange = (e) => {
    ...
    if(pattern.test(e.target.value))
    {
        ...
        this.setState({isValid : false, errorMsg : "Please enter only numbers.", mobile : e.target.value});
          ...
          <div className="flex-w flex-tr">
            ...
            <div className="kyc_rightbar flex-col-m justify-content-center">
              ...
              <div className="form_details">
                <h4 className="text-center">Rent Details</h4>
                ...
                <span className="has-float-label">
                  <input onChange={this.handleChange} value={this.state.mincome?this.state.mincome:''} className="rupeeprefix" id="mincome" name="mincome" type="text" placeholder=" "/>
