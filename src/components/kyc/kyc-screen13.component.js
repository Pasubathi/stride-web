...
import { uploadDocument, getOtherDocument, removeDocument, fraudCheck } from "../../actions/user"
            ...
            try {
                    ...
                    if(response.status =="success")
                    {
                        ...
                        if(type == 1)
                        {
                            ...
                            if(doctAttempt > 2)
                            {
                                this.setState({validFrontPic: false, frontErrorMsg: "Your document not verified Still you can submit to backend verification"});
                                resolve(true);
                            }else{
                                this.setState({validFrontPic: false, frontSuccessMsg:'', frontErrorMsg: response.message?response.message:"Invalid Document"});
                                resolve(false);
                            }
                        }else {
                            ...
                            if(doctAttempt > 2)
                            {
                                this.setState({validBackPic: false, backErrorMsg: "Your document not verified Still you can submit to backend verification"});
                                resolve(true);
                            }else{
                                this.setState({validBackPic: false, backSuccessMsg:'', backErrorMsg: response.message?response.message:"Invalid Document"});
                                resolve(false);
                            }
                        }
                    }
