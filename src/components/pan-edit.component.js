    ...
    return (
      ...
      {isLoading?(
        <div className="loading">Loading&#8230;</div>
         ...
         <section className="bg0 login page_registration panpages">
              <div className="container-zero">
                <div className="flex-w flex-tr">
                  <div className="size-50 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md primary-card">
                    <div className="d-flex flex-column">
                    <div className="textpart">
                    <h4 onClick={ () => history.push('/home')} className="mtext-105 cl2 txt-center p-b-30 cursor-point">eduvanz.</h4>
                      <h1 className="titfnt">
              ...
              <div className="loginform">
                ...
                >
                  ...
                  <div className="col-md-12 mr-btn-sty" style={{justifyContent: 'center', textAlign: 'center'}}>
                      ...
                      This will not impact your bureau score in anyway.
                      </p>
                  </div>
