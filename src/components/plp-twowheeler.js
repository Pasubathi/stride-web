...
import { getProductByCategory, favProduct, getSimilarProduct } from "../actions/user";
                                ...
                                <div className="col-lg-4">
                                    ...
                                    <div className="search___ mt-lg-5">
                                        <input
                                            ...
                                            placeholder={`Search for ${category} that suits you`} />
                                            ...
                                            {isCompareEnable && (
                                                <div className='compare-check compare-checkbox'>
                                                    <div className="custom-control custom-checkbox">
                                                        <input type="checkbox" className="custom-control-input" id={item.id} ref={`ref_${item.id}`} onChange={ e =>this.onSelectClick(e, item)} value={item.id} defaultChecked={this.state.selectedItem.includes(item.id)} />
