        ...
        <>
            <div className="item one">
                ...
                <div className="img-box">
                    <img src={product_mid.image_url__c} className="img-fluid"/>
                </div>
            </div>
            {product_long && <div className="item two">
                ...
                <div className="img-box">
                    <img src={product_long.image_url__c} className="img-fluid"/>
                </div>
            </div>}
        </>
    )
                ...
                <div className="row">
                    <div className="col-6">
                        <div className="item five">
                            ...
                            <div className="top">
                                <p>{product_small1.name}</p>
                                <h4>
                                    No Cost EMI
                                    <span
                                        className="d-block mb-3">Starting ₹2,200 </span>
                                </h4>
                            ...
                            <div className="img-box">
                                <img src={product_small1.image_url__c} className="img-fluid"/>
                    ...
                    {product_small2 && <div className="col-6">
                        <div className="item six">
                            ...
                            <div className="img-box">
                                <img src={product_small2.image_url__c} className="img-fluid"/>
    ...
    return (
        <>
            <div className="item saven">
                ...
                <div className="top">
                    <p>{product_large.name}</p>
                    <h4>
                        No Cost EMI Starting
                        <span className="d-block mb-4">₹2,200 </span>
                    </h4>
                    <button className="brand_icon">{product_large.brand_icon}</button>
                </div>
                <div className="img-box">
                    <img src={product_large.image_url__c} className="img-fluid"/>
                </div>
