...
import VirtualCard1 from "./components/virtual/virtual-card1.component";
import VirtualCard2 from "./components/virtual/virtual-card2.component";
import VirtualCard3 from "./components/virtual/virtual-card3.component";
import VirtualCard4 from "./components/virtual/virtual-card4.component";
      ...
      <>
        <Router history={history} appUrl={this.state.appUrl}>
          <Switch>
            ...
            <Route exact path="/bank_screen" component={BankScreen} />
            ...
            <Route exact path="/bank_screen5" component={BankScreen5} />
            <Route exact path="/bank_screen6" component={BankScreen6} />
            <Route exact path="/ed_upload" component={BankScreen7} />
            <Route exact path="/ed_after_upload" component={BankScreen8} />
            <Route exact path={"/edplans/:id"} render={(props) => { return (<BankScreen9 id={props.match.params.id} history={history} />) }} />
            ...
            <Route exact path="/bank_enach" component={BankEnach} />
            <Route exact path="/bank_enach1" component={ManualEnach1} />
            <Route exact path="/ed_enach" component={ManualEnach2} />
            ...
            <Route exact path="/payment_success" component={OrderConfirm} />
